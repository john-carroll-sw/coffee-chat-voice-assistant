        ...
        <div className={`app flex min-h-screen flex-col bg-gray-100 text-gray-900 ${theme}`}>
            ...
            <main className="flex flex-grow flex-col items-center justify-center">
                ...
                <div className="mb-4 flex space-x-4">
                    <Button onClick={() => setShowMenu(!showMenu)} className="h-12 w-60 bg-green-500 hover:bg-green-600" aria-label={t("app.showMenu")}>
                        {t("app.showMenu")}
                    </Button>
            ...
            <MenuPanel show={showMenu} documents={menuDocuments} onClosed={() => setShowMenu(false)} />
